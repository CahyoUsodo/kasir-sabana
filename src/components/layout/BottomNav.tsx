...
export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-border bg-card/95 backdrop-blur-lg" style={{ marginBottom: 'calc(-1 * env(safe-area-inset-bottom, 0px))' }}>
